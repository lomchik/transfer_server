...
WebSocketConnection.prototype.handleSocketError = function(error) {
    // log((new Date()) + " - Socket Error - Closing Connection: " + error);
...
WebSocketConnection.prototype.handleSocketClose = function(hadError) {
    ...
    if (!this.closeEventEmitted) {
        ...
        // log((new Date()) + " - Emitting WebSocketConnection close event");
...
WebSocketConnection.prototype.close = function() {
    // log((new Date()) + " - Initating clean WebSocket close sequence.");
    if (this.connected) {
...
WebSocketConnection.prototype.setCloseTimer = function() {
    this.clearCloseTimer();
    // log((new Date()) + " - Setting close timer");
...
WebSocketConnection.prototype.clearCloseTimer = function() {
    if (this.closeTimer) {
        // log((new Date()) + " - Clearing close timer");
...
WebSocketConnection.prototype.handleCloseTimer = function() {
    ...
    if (this.waitingForCloseResponse) {
        // log((new Date()) + " - Close response not received from client.  Forcing socket end.");
        this.waitingForCloseResponse = false;
        this.socket.end();
    }
};
...
WebSocketConnection.prototype.processFrame = function(frame) {
    ...
    switch(frame.opcode) {
        ...
        case 0x08: // WebSocketFrame.CONNECTION_CLOSE
            // log((new Date()) + " - Received close frame");
            if (this.waitingForCloseResponse) {
                // Got response to our request to close the connection.
                // Close is complete, so we just hang up.
                // log((new Date()) + " - Got close response from peer.");
                this.clearCloseTimer();
                this.waitingForCloseResponse = false;
                this.state = STATE_CLOSED;
                this.socket.end();
                ...
                // log((new Date()) + " Remote peer " + this.remoteAddress +
